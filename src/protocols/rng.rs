...
pub const ALGORITHM_SP800_90_HASH_256: Algorithm = crate::base::Guid::from_fields(
    0xa7af67cb,
    0x603b,
    0x4d42,
    0xba,
...
pub const ALGORITHM_SP800_90_CTR_256: Algorithm = crate::base::Guid::from_fields(
    0x44f0de6e,
    0x4d8c,
    0x4045,
    0xa8,
...
pub const ALGORITHM_X9_31_3DES: Algorithm = crate::base::Guid::from_fields(
    0x63c4785a,
    0xca34,
    0x4012,
    0xa3,
...
pub type GetInfo = eficall! {fn(
    *mut Protocol,
    *mut usize,
    *mut Algorithm,
) -> crate::base::Status};

pub type GetRNG = eficall! {fn(
    *mut Protocol,
    *mut Algorithm,
    usize,
    *mut u8,
